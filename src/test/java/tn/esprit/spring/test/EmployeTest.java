...
public class EmployeTest {
	...
	public void init() {
		...
		L.info("startup - Ajouter Employe et departement");
		 Employe employe= new Employe("Lazhar", "Karem" ,"karem.lazhar@gmail.com", true, Role.INGENIEUR);
	...
	public void testAjouterEmploye() {
		...
		EmplService.mettreAjourEmailByEmployeId("karem.lazhar@gmail.com",idEmp);
